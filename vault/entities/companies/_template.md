...
aliases: []                  # e.g. ["Hazel"] — other names this entity goes by
layer: vendor                # one of: federal | state | district | charter | vendor | ideas
...
<!--
  One short paragraph: what is true about this entity NOW. OVERWRITE this section on every
  update. End with "*(as of <YYYY-Www>)*".
-->
